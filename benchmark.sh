...
hyperfine "./build_naive_rc/main" "./build_rc_regions/main" "./build_safe_baseline/main" "./build_safe_32/main" "./build_safe_64/main" "./build_safe_fastest/main" "./build_unsafe_no_bounds/main" "./build_unsafe_with_bounds/main" "./build_resilientv3/main" --warmup 30 --runs 500 --export-csv summary.csv
