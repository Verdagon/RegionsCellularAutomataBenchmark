...
@__vale_nextGen = local_unnamed_addr global i64 655360000
...
localsBlock:
  ...
  %add.i.i29 = add i64 %add.i.i, %0
  %diff.i.i = mul i64 %add.i.i29, -33554431
  %add.i.i30 = sdiv i64 %diff.i.i, 134217728
  %add.i.i31 = add i64 %add.i.i30, %diff.i.i
  %mul.i.i32 = mul i64 %add.i.i31, 2685821657736338717
  %add.i.i33 = sdiv i64 %mul.i.i32, 4294967296
  %1 = tail call dereferenceable_or_null(24) ptr @malloc(i64 24)
  %counterPrevVal.i = load i64, ptr @__vale_nextGen, align 8
  %counterNewVal.i = add i64 %counterPrevVal.i, 1
  store i64 %counterNewVal.i, ptr @__vale_nextGen, align 8
  store i64 %counterPrevVal.i, ptr %1, align 4
  %contentsPtr.i = getelementptr inbounds %Tup_i64_i64_0rc, ptr %1, i64 0, i32 1
  store i64 %add.i.i31, ptr %contentsPtr.i, align 4
  %b.i = getelementptr inbounds %Tup_i64_i64_0rc, ptr %1, i64 0, i32 1, i32 1
  store i64 %add.i.i33, ptr %b.i, align 4
  ret ptr %1
}
...
localsBlock:
  ...
  %counterPrevVal = load i64, ptr @__vale_nextGen, align 8
  %counterNewVal = add i64 %counterPrevVal, 1
  store i64 %counterNewVal, ptr @__vale_nextGen, align 8
  store i64 %counterPrevVal, ptr %2, align 4
...
localsBlock:
  ...
  %rsaLen.i212 = load i32, ptr %rsaLenPtr.i, align 4
  %2 = icmp sgt i32 %rsaLen.i212, 0
  br i1 %2, label %pop_0.exit, label %block4

pop_0.exit:                                       ; preds = %localsBlock, %block1
  %rsaLen.i213 = phi i32 [ %rsaLen.i, %block1 ], [ %rsaLen.i212, %localsBlock ]
  %index1.i = add nsw i32 %rsaLen.i213, -1
  %3 = zext i32 %index1.i to i64
  %indexPtr.i = getelementptr inbounds %rsa_1rc, ptr %0, i64 0, i32 3, i64 %3
  %index3.i = load ptr, ptr %indexPtr.i, align 8
  store i32 %index1.i, ptr %rsaLenPtr.i, align 4
  %rsaLenPtr.i163 = getelementptr inbounds %rsa_0rc, ptr %index3.i, i64 0, i32 1
  %rsaLenPtr.i163.promoted = load i32, ptr %rsaLenPtr.i163, align 4
  %or.cond = icmp sgt i32 %rsaLenPtr.i163.promoted, -1
  br i1 %or.cond, label %block1, label %4

block4:                                           ; preds = %block1, %localsBlock
  %rsaLen.i.lcssa = phi i32 [ %rsaLen.i212, %localsBlock ], [ %rsaLen.i, %block1 ]
  %nonEmpty36.not = icmp eq i32 %rsaLen.i.lcssa, 0
  br i1 %nonEmpty36.not, label %7, label %6
...
block1:                                           ; preds = %pop_0.exit
  tail call void @free(ptr nonnull %index3.i)
  %rsaLen.i = load i32, ptr %rsaLenPtr.i, align 4
  %5 = icmp sgt i32 %rsaLen.i, 0
  br i1 %5, label %pop_0.exit, label %block4
...
7:                                                ; preds = %block4
  ...
  %8 = tail call ptr @CellularAutomata_0(ptr %1)
  %rsaLenPtr.i171 = getelementptr inbounds %rsa_1rc, ptr %1, i64 0, i32 1
  %rsaLen.i172218 = load i32, ptr %rsaLenPtr.i171, align 4
  %9 = icmp sgt i32 %rsaLen.i172218, 0
  br i1 %9, label %pop_0.exit179, label %block14

pop_0.exit179:                                    ; preds = %7, %block11
  %rsaLen.i172219 = phi i32 [ %rsaLen.i172, %block11 ], [ %rsaLen.i172218, %7 ]
  %index1.i176 = add nsw i32 %rsaLen.i172219, -1
  %10 = zext i32 %index1.i176 to i64
  %indexPtr.i177 = getelementptr inbounds %rsa_1rc, ptr %1, i64 0, i32 3, i64 %10
  %index3.i178 = load ptr, ptr %indexPtr.i177, align 8
  store i32 %index1.i176, ptr %rsaLenPtr.i171, align 4
  %rsaLenPtr.i180 = getelementptr inbounds %rsa_0rc, ptr %index3.i178, i64 0, i32 1
  %rsaLenPtr.i180.promoted = load i32, ptr %rsaLenPtr.i180, align 4
  %or.cond239 = icmp sgt i32 %rsaLenPtr.i180.promoted, -1
  br i1 %or.cond239, label %block11, label %11

block14:                                          ; preds = %block11, %7
  %rsaLen.i172.lcssa = phi i32 [ %rsaLen.i172218, %7 ], [ %rsaLen.i172, %block11 ]
  %nonEmpty84.not = icmp eq i32 %rsaLen.i172.lcssa, 0
  br i1 %nonEmpty84.not, label %block22, label %13

11:                                               ; preds = %pop_0.exit179
  tail call void @__vprintCStr(ptr nonnull @conststr35)
  tail call void @exit(i64 1)
  unreachable

block11:                                          ; preds = %pop_0.exit179
  tail call void @free(ptr nonnull %index3.i178)
  %rsaLen.i172 = load i32, ptr %rsaLenPtr.i171, align 4
  %12 = icmp sgt i32 %rsaLen.i172, 0
  br i1 %12, label %pop_0.exit179, label %block14
...
block22:                                          ; preds = %block14
  tail call void @free(ptr nonnull %1)
  %rsaLenPtr.i189 = getelementptr inbounds %rsa_1rc, ptr %8, i64 0, i32 1
  %rsaLen.i190224 = load i32, ptr %rsaLenPtr.i189, align 4
  %14 = icmp sgt i32 %rsaLen.i190224, 0
  br i1 %14, label %pop_0.exit197, label %block27

pop_0.exit197:                                    ; preds = %block22, %block24
  %rsaLen.i190225 = phi i32 [ %rsaLen.i190, %block24 ], [ %rsaLen.i190224, %block22 ]
  %index1.i194 = add nsw i32 %rsaLen.i190225, -1
  %15 = zext i32 %index1.i194 to i64
  %indexPtr.i195 = getelementptr inbounds %rsa_1rc, ptr %8, i64 0, i32 3, i64 %15
  %index3.i196 = load ptr, ptr %indexPtr.i195, align 8
  store i32 %index1.i194, ptr %rsaLenPtr.i189, align 4
  %rsaLenPtr.i198 = getelementptr inbounds %rsa_0rc, ptr %index3.i196, i64 0, i32 1
  %rsaLenPtr.i198.promoted = load i32, ptr %rsaLenPtr.i198, align 4
  %or.cond240 = icmp sgt i32 %rsaLenPtr.i198.promoted, -1
  br i1 %or.cond240, label %block24, label %16

block27:                                          ; preds = %block24, %block22
  %rsaLen.i190.lcssa = phi i32 [ %rsaLen.i190224, %block22 ], [ %rsaLen.i190, %block24 ]
  %nonEmpty133.not = icmp eq i32 %rsaLen.i190.lcssa, 0
  br i1 %nonEmpty133.not, label %19, label %18

16:                                               ; preds = %pop_0.exit197
  tail call void @__vprintCStr(ptr nonnull @conststr35)
  tail call void @exit(i64 1)
  unreachable

block24:                                          ; preds = %pop_0.exit197
  tail call void @free(ptr nonnull %index3.i196)
  %rsaLen.i190 = load i32, ptr %rsaLenPtr.i189, align 4
  %17 = icmp sgt i32 %rsaLen.i190, 0
  br i1 %17, label %pop_0.exit197, label %block27
...
define ptr @CellularAutomata_0(ptr nocapture readonly %0) local_unnamed_addr {
localsBlock:
...
block3:                                           ; preds = %localsBlock, %push_1.exit
  %row_i_1.0183 = phi i32 [ 0, %localsBlock ], [ %add.i.i153, %push_1.exit ]
  %counterNewVal.i147181182 = phi i64 [ %counterNewVal.i, %localsBlock ], [ %counterNewVal.i147, %push_1.exit ]
  %2 = tail call dereferenceable_or_null(4016) ptr @malloc(i64 4016)
  %counterNewVal.i147 = add i64 %counterNewVal.i147181182, 1
  store i64 %counterNewVal.i147, ptr @__vale_nextGen, align 8
  store i64 %counterNewVal.i147181182, ptr %2, align 4
  %rsaLenPtr.i148 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 1
  store i32 0, ptr %rsaLenPtr.i148, align 4
  %rsaCapacityPtr.i149 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 2
  store i32 4000, ptr %rsaCapacityPtr.i149, align 4
  %3 = tail call i32 @llvm.smax.i32(i32 %row_i_1.0183, i32 1)
  %4 = add nsw i32 %3, -1
  %add.i.i153 = add nuw nsw i32 %row_i_1.0183, 1
  %5 = tail call i32 @llvm.smin.i32(i32 %add.i.i153, i32 999)
  %.not176 = icmp sgt i32 %4, %5
  %6 = zext i32 %row_i_1.0183 to i64
  %indexPtr45 = getelementptr inbounds %rsa_1rc, ptr %0, i64 0, i32 3, i64 %6
  br label %block8
...
block8:                                           ; preds = %block3, %push_0.exit
  %col_i_1.0180 = phi i32 [ 0, %block3 ], [ %add.i.i166, %push_0.exit ]
  br i1 %.not176, label %block38, label %block13.lr.ph

block13.lr.ph:                                    ; preds = %block8
  %7 = tail call i32 @llvm.smax.i32(i32 %col_i_1.0180, i32 1)
  %8 = add nsw i32 %7, -1
  %9 = tail call i32 @llvm.smin.i32(i32 %col_i_1.0180, i32 3998)
  %10 = add nuw nsw i32 %9, 1
  %.not168173 = icmp ugt i32 %8, %10
  br label %block13
...
push_1.exit:                                      ; preds = %block9
  %counterNewVal.i152 = add nuw i32 %rsaLen.i, 1
  store i32 %counterNewVal.i152, ptr %rsaLenPtr.i, align 4
  ...
  %13 = icmp ult i32 %row_i_1.0183, 999
  br i1 %13, label %block3, label %block4

block13:                                          ; preds = %block13.lr.ph, %block19
  %num_walkable_neighbors_0.0178 = phi i32 [ 0, %block13.lr.ph ], [ %num_walkable_neighbors_0.1.lcssa, %block19 ]
  %neighbor_row_i_0.0177 = phi i32 [ %4, %block13.lr.ph ], [ %add.i.i156, %block19 ]
  br i1 %.not168173, label %block19, label %block18.lr.ph

block18.lr.ph:                                    ; preds = %block13
  %14 = icmp ne i32 %row_i_1.0183, %neighbor_row_i_0.0177
  %15 = sext i32 %neighbor_row_i_0.0177 to i64
...
block18:                                          ; preds = %block18.lr.ph, %block29
  %num_walkable_neighbors_0.1175 = phi i32 [ %num_walkable_neighbors_0.0178, %block18.lr.ph ], [ %num_walkable_neighbors_0.2, %block29 ]
  %neighbor_col_i_0.0174 = phi i32 [ %8, %block18.lr.ph ], [ %add.i.i158, %block29 ]
  %17 = icmp ne i32 %col_i_1.0180, %neighbor_col_i_0.0174
  %or.cond = select i1 %14, i1 true, i1 %17
  br i1 %or.cond, label %block24, label %block29

block19:                                          ; preds = %block29, %block13
  %num_walkable_neighbors_0.1.lcssa = phi i32 [ %num_walkable_neighbors_0.0178, %block13 ], [ %num_walkable_neighbors_0.2, %block29 ]
  %add.i.i156 = add nuw nsw i32 %neighbor_row_i_0.0177, 1
  %.not.not = icmp ult i32 %neighbor_row_i_0.0177, %5
  br i1 %.not.not, label %block13, label %block14

block24:                                          ; preds = %block18
  %rsaLen = load i32, ptr %rsaLenPtr, align 4
  %outOfBounds.not = icmp ult i32 %neighbor_row_i_0.0177, %rsaLen
...
19:                                               ; preds = %block24
  ...
  %rsaLenPtr18 = getelementptr inbounds %rsa_0rc, ptr %index, i64 0, i32 1
  %rsaLen19 = load i32, ptr %rsaLenPtr18, align 4
  %outOfBounds21.not = icmp ult i32 %neighbor_col_i_0.0174, %rsaLen19
  br i1 %outOfBounds21.not, label %21, label %20
...
21:                                               ; preds = %19
  %22 = sext i32 %neighbor_col_i_0.0174 to i64
  %indexPtr24 = getelementptr inbounds %rsa_0rc, ptr %index, i64 0, i32 3, i64 %22
  %index25 = load i1, ptr %indexPtr24, align 1
  %add.i.i157 = zext i1 %index25 to i32
  %spec.select = add i32 %num_walkable_neighbors_0.1175, %add.i.i157
  br label %block29

block29:                                          ; preds = %21, %block18
  %num_walkable_neighbors_0.2 = phi i32 [ %num_walkable_neighbors_0.1175, %block18 ], [ %spec.select, %21 ]
  %add.i.i158 = add nuw nsw i32 %neighbor_col_i_0.0174, 1
  %.not168 = icmp ugt i32 %neighbor_col_i_0.0174, %9
  br i1 %.not168, label %block19, label %block18

block31:                                          ; preds = %block14
  %.not167 = icmp eq i32 %num_walkable_neighbors_0.1.lcssa, 4
  br i1 %.not167, label %block33, label %block38

block33:                                          ; preds = %block31
  %rsaLen40 = load i32, ptr %rsaLenPtr, align 4
  %outOfBounds42.not = icmp ult i32 %row_i_1.0183, %rsaLen40
  br i1 %outOfBounds42.not, label %24, label %23
...
24:                                               ; preds = %block33
  ...
  %rsaLenPtr48 = getelementptr inbounds %rsa_0rc, ptr %index46, i64 0, i32 1
  %rsaLen49 = load i32, ptr %rsaLenPtr48, align 4
  %outOfBounds51.not = icmp ult i32 %col_i_1.0180, %rsaLen49
  br i1 %outOfBounds51.not, label %26, label %25
...
26:                                               ; preds = %24
  %27 = zext i32 %col_i_1.0180 to i64
  %indexPtr54 = getelementptr inbounds %rsa_0rc, ptr %index46, i64 0, i32 3, i64 %27
  %index55 = load i1, ptr %indexPtr54, align 1
  br label %block38

block38:                                          ; preds = %block8, %26, %block31, %block14
  %28 = phi i1 [ false, %block14 ], [ true, %block31 ], [ %index55, %26 ], [ false, %block8 ]
  %rsaLen.i160 = load i32, ptr %rsaLenPtr.i148, align 4
  %rsaCapacity.i162 = load i32, ptr %rsaCapacityPtr.i149, align 4
  %outOfBounds.not.i163 = icmp ult i32 %rsaLen.i160, %rsaCapacity.i162
  br i1 %outOfBounds.not.i163, label %push_0.exit, label %29
...
push_0.exit:                                      ; preds = %block38
  %counterNewVal.i164 = add nuw i32 %rsaLen.i160, 1
  store i32 %counterNewVal.i164, ptr %rsaLenPtr.i148, align 4
  %30 = sext i32 %rsaLen.i160 to i64
  %destPtr.i165 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 3, i64 %30
  store i1 %28, ptr %destPtr.i165, align 1
  %add.i.i166 = add nuw nsw i32 %col_i_1.0180, 1
  %31 = icmp ult i32 %col_i_1.0180, 3999
...
define ptr @MakeBoard_0(i64 %0) local_unnamed_addr {
localsBlock:
  %1 = tail call dereferenceable_or_null(8016) ptr @malloc(i64 8016)
  %counterPrevVal.i = load i64, ptr @__vale_nextGen, align 8
  %counterNewVal.i = add i64 %counterPrevVal.i, 1
...
block3:                                           ; preds = %localsBlock, %push_1.exit
  %rand_seed_0.086 = phi i64 [ %0, %localsBlock ], [ %add.i.i31.i, %push_1.exit ]
  %row_i_0.085 = phi i32 [ 0, %localsBlock ], [ %add.i.i76, %push_1.exit ]
  %counterNewVal.i.i78.lcssa8384 = phi i64 [ %counterNewVal.i, %localsBlock ], [ %3, %push_1.exit ]
  %2 = tail call dereferenceable_or_null(4016) ptr @malloc(i64 4016)
  %counterNewVal.i63 = add i64 %counterNewVal.i.i78.lcssa8384, 1
  store i64 %counterNewVal.i.i78.lcssa8384, ptr %2, align 4
  %rsaLenPtr.i64 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 1
  store i32 0, ptr %rsaLenPtr.i64, align 4
  %rsaCapacityPtr.i65 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 2
  store i32 4000, ptr %rsaCapacityPtr.i65, align 4
  %3 = add i64 %counterNewVal.i.i78.lcssa8384, 4001
  br label %block8

block4:                                           ; preds = %push_1.exit
  store i64 %3, ptr @__vale_nextGen, align 8
  ret ptr %1

block8:                                           ; preds = %block3, %push_0.exit
  %rand_seed_0.181 = phi i64 [ %rand_seed_0.086, %block3 ], [ %add.i.i31.i, %push_0.exit ]
  %col_i_0.080 = phi i32 [ 0, %block3 ], [ %add.i.i, %push_0.exit ]
  %counterNewVal.i.i7879 = phi i64 [ %counterNewVal.i63, %block3 ], [ %counterNewVal.i.i, %push_0.exit ]
  %counterNewVal.i.i = add i64 %counterNewVal.i.i7879, 1
  %rsaLen.i = load i32, ptr %rsaLenPtr.i64, align 4
  %rsaCapacity.i = load i32, ptr %rsaCapacityPtr.i65, align 4
  %outOfBounds.not.i = icmp ult i32 %rsaLen.i, %rsaCapacity.i
  br i1 %outOfBounds.not.i, label %push_0.exit, label %4

4:                                                ; preds = %block8
  store i64 %counterNewVal.i.i, ptr @__vale_nextGen, align 8
  tail call void @__vprintCStr(ptr nonnull @conststr41)
  tail call void @exit(i64 1)
  unreachable

push_0.exit:                                      ; preds = %block8
  %add.i.i.i = sdiv i64 %rand_seed_0.181, 200096
  %add.i.i29.i = add i64 %add.i.i.i, %rand_seed_0.181
  %diff.i.i.i = mul i64 %add.i.i29.i, -33554431
  %add.i.i30.i = sdiv i64 %diff.i.i.i, 134217728
  %add.i.i31.i = add i64 %add.i.i30.i, %diff.i.i.i
  %mul.i.i32.i = mul i64 %add.i.i31.i, 2685821657736338717
  %add.i.i33.i = sdiv i64 %mul.i.i32.i, 4294967296
  %5 = and i64 %add.i.i33.i, 1
  %6 = icmp eq i64 %5, 0
  %counterNewVal.i68 = add nuw i32 %rsaLen.i, 1
  store i32 %counterNewVal.i68, ptr %rsaLenPtr.i64, align 4
  %7 = sext i32 %rsaLen.i to i64
  %destPtr.i = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 3, i64 %7
  store i1 %6, ptr %destPtr.i, align 1
  %add.i.i = add nuw nsw i32 %col_i_0.080, 1
  %8 = icmp ult i32 %col_i_0.080, 3999
  br i1 %8, label %block8, label %block9

block9:                                           ; preds = %push_0.exit
  %rsaLen.i70 = load i32, ptr %rsaLenPtr.i, align 4
  %rsaCapacity.i72 = load i32, ptr %rsaCapacityPtr.i, align 4
  %outOfBounds.not.i73 = icmp ult i32 %rsaLen.i70, %rsaCapacity.i72
  br i1 %outOfBounds.not.i73, label %push_1.exit, label %9
...
push_1.exit:                                      ; preds = %block9
  %counterNewVal.i74 = add nuw i32 %rsaLen.i70, 1
  store i32 %counterNewVal.i74, ptr %rsaLenPtr.i, align 4
  %10 = sext i32 %rsaLen.i70 to i64
  %destPtr.i75 = getelementptr inbounds %rsa_1rc, ptr %1, i64 0, i32 3, i64 %10
  store ptr %2, ptr %destPtr.i75, align 8
  %add.i.i76 = add nuw nsw i32 %row_i_0.085, 1
  %11 = icmp ult i32 %row_i_0.085, 999
...
block6.preheader:                                 ; preds = %localsBlock, %block9
  %row_i_2.066 = phi i32 [ 0, %localsBlock ], [ %add.i.i, %block9 ]
  %1 = zext i32 %row_i_2.066 to i64
...
block8:                                           ; preds = %block6.preheader, %block13
  %col_i_2.065 = phi i32 [ 0, %block6.preheader ], [ %add.i.i64, %block13 ]
  %rsaLen = load i32, ptr %rsaLenPtr, align 4
  %outOfBounds.not = icmp ult i32 %row_i_2.066, %rsaLen
  br i1 %outOfBounds.not, label %6, label %5

block9:                                           ; preds = %block13
  %2 = tail call dereferenceable_or_null(14) ptr @malloc(i64 14)
  store i32 1, ptr %2, align 4
  %strInnerStructPtr31 = getelementptr inbounds %__Str_rc, ptr %2, i64 0, i32 1
  store i32 1, ptr %strInnerStructPtr31, align 4
  %charsPtr34 = getelementptr inbounds %__Str_rc, ptr %2, i64 1
  tail call void @strncpy(ptr nonnull %charsPtr34, ptr nonnull @conststr39, i64 1)
  %charsEndPtrZ36 = getelementptr inbounds i8, ptr %2, i64 13
  store i8 0, ptr %charsEndPtrZ36, align 1
  %3 = tail call i37 @print_0(ptr nonnull %2)
  %add.i.i = add nuw nsw i32 %row_i_2.066, 1
  %4 = icmp ult i32 %row_i_2.066, 999
...
6:                                                ; preds = %block8
  %index = load ptr, ptr %indexPtr, align 8
  %rsaLenPtr8 = getelementptr inbounds %rsa_0rc, ptr %index, i64 0, i32 1
  %rsaLen9 = load i32, ptr %rsaLenPtr8, align 4
  %outOfBounds11.not = icmp ult i32 %col_i_2.065, %rsaLen9
  br i1 %outOfBounds11.not, label %block13, label %7
...
block13:                                          ; preds = %6
  %8 = zext i32 %col_i_2.065 to i64
  %indexPtr14 = getelementptr inbounds %rsa_0rc, ptr %index, i64 0, i32 3, i64 %8
  ...
  %conststr37.conststr38 = select i1 %index15, ptr @conststr37, ptr @conststr38
  ...
  %add.i.i64 = add nuw nsw i32 %col_i_2.065, 1
  %11 = icmp ult i32 %col_i_2.065, 3999
...
define i32 @len_1(%rsa_0w %0) local_unnamed_addr #6 {
localsBlock:
...
define i37 @push_1(%rsa_1w %0, ptr %1) local_unnamed_addr {
localsBlock:
  ...
  br i1 %outOfBounds.not, label %4, label %3
...
4:                                                ; preds = %localsBlock
  ...
  %5 = sext i32 %rsaLen to i64
  %destPtr = getelementptr inbounds %rsa_1rc, ptr %2, i64 0, i32 3, i64 %5
...
define i1 @pop_1(%rsa_0w %0) local_unnamed_addr {
localsBlock:
  %1 = extractvalue %rsa_0w %0, 1
  %rsaLenPtr = getelementptr inbounds %rsa_0rc, ptr %1, i64 0, i32 1
  %rsaLen = load i32, ptr %rsaLenPtr, align 4
...
3:                                                ; preds = %localsBlock
  %index1 = add i32 %rsaLen, -1
  %4 = sext i32 %index1 to i64
  %indexPtr = getelementptr inbounds %rsa_0rc, ptr %1, i64 0, i32 3, i64 %4
  %index3 = load i1, ptr %indexPtr, align 1
  store i32 %index1, ptr %rsaLenPtr, align 4
  ret i1 %index3
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define i32 @len_0(%rsa_1w %0) local_unnamed_addr #6 {
localsBlock:
  %1 = extractvalue %rsa_1w %0, 1
  %rsaLenPtr = getelementptr inbounds %rsa_1rc, ptr %1, i64 0, i32 1
  %rsaLen = load i32, ptr %rsaLenPtr, align 4
  ret i32 %rsaLen
}
...
define i37 @push_0(%rsa_0w %0, i1 %1) local_unnamed_addr {
localsBlock:
  %2 = extractvalue %rsa_0w %0, 1
  %rsaLenPtr = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 1
  %rsaLen = load i32, ptr %rsaLenPtr, align 4
  %rsaCapacityPtr = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 2
  %rsaCapacity = load i32, ptr %rsaCapacityPtr, align 4
  %outOfBounds.not = icmp ult i32 %rsaLen, %rsaCapacity
  br i1 %outOfBounds.not, label %4, label %3
...
4:                                                ; preds = %localsBlock
  ...
  store i32 %counterNewVal, ptr %rsaLenPtr, align 4
  %5 = sext i32 %rsaLen to i64
  %destPtr = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 3, i64 %5
  store i1 %1, ptr %destPtr, align 1
  ret i37 undef
}

define ptr @pop_0(%rsa_1w %0) local_unnamed_addr {
localsBlock:
  %1 = extractvalue %rsa_1w %0, 1
  %rsaLenPtr = getelementptr inbounds %rsa_1rc, ptr %1, i64 0, i32 1
  %rsaLen = load i32, ptr %rsaLenPtr, align 4
...
3:                                                ; preds = %localsBlock
  %index1 = add i32 %rsaLen, -1
  %4 = sext i32 %index1 to i64
  %indexPtr = getelementptr inbounds %rsa_1rc, ptr %1, i64 0, i32 3, i64 %4
...
localsBlock:
  ...
  %counterNewVal = add i64 %counterPrevVal, 1
  store i64 %counterNewVal, ptr @__vale_nextGen, align 8
  store i64 %counterPrevVal, ptr %1, align 4
  %rsaLenPtr = getelementptr inbounds %rsa_0rc, ptr %1, i64 0, i32 1
  store i32 0, ptr %rsaLenPtr, align 4
...
attributes #5 = { mustprogress nofree nounwind willreturn memory(readwrite, argmem: none) }
