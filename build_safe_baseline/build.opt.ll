...
%Tup_i64_i64_0rc = type { %mutControlBlock, %Tup_i64_i64_0 }
%mutControlBlock = type { i64 }
%Tup_i64_i64_0 = type { i64, i64 }
%rsa_1rc = type { %mutControlBlock, i32, i32, [0 x ptr] }
%rsa_0rc = type { %mutControlBlock, i32, i32, [0 x i1] }
...
block3:                                           ; preds = %localsBlock, %push_1.exit
  %row_i_1.0278 = phi i32 [ 0, %localsBlock ], [ %add.i.i248, %push_1.exit ]
  %counterNewVal.i242276277 = phi i64 [ %counterNewVal.i, %localsBlock ], [ %counterNewVal.i242, %push_1.exit ]
  %2 = tail call dereferenceable_or_null(4016) ptr @malloc(i64 4016)
  %counterNewVal.i242 = add i64 %counterNewVal.i242276277, 1
  store i64 %counterNewVal.i242, ptr @__vale_nextGen, align 8
  store i64 %counterNewVal.i242276277, ptr %2, align 4
  %rsaLenPtr.i243 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 1
  store i32 0, ptr %rsaLenPtr.i243, align 4
  %rsaCapacityPtr.i244 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 2
  store i32 4000, ptr %rsaCapacityPtr.i244, align 4
  %3 = tail call i32 @llvm.smax.i32(i32 %row_i_1.0278, i32 1)
  %4 = add nsw i32 %3, -1
  %add.i.i248 = add nuw nsw i32 %row_i_1.0278, 1
  %5 = tail call i32 @llvm.smin.i32(i32 %add.i.i248, i32 999)
  %.not271 = icmp sgt i32 %4, %5
  %6 = zext i32 %row_i_1.0278 to i64
...
block8:                                           ; preds = %block3, %push_0.exit
  %col_i_1.0275 = phi i32 [ 0, %block3 ], [ %add.i.i261, %push_0.exit ]
  br i1 %.not271, label %block38, label %block13.lr.ph

block13.lr.ph:                                    ; preds = %block8
  %7 = tail call i32 @llvm.smax.i32(i32 %col_i_1.0275, i32 1)
  %8 = add nsw i32 %7, -1
  %9 = tail call i32 @llvm.smin.i32(i32 %col_i_1.0275, i32 3998)
  %10 = add nuw nsw i32 %9, 1
  %.not263268 = icmp ugt i32 %8, %10
  br label %block13
...
push_1.exit:                                      ; preds = %block9
  %counterNewVal.i247 = add nuw i32 %rsaLen.i, 1
  store i32 %counterNewVal.i247, ptr %rsaLenPtr.i, align 4
  ...
  %13 = icmp ult i32 %row_i_1.0278, 999
  br i1 %13, label %block3, label %block4

block13:                                          ; preds = %block13.lr.ph, %block19
  %num_walkable_neighbors_0.0273 = phi i32 [ 0, %block13.lr.ph ], [ %num_walkable_neighbors_0.1.lcssa, %block19 ]
  %neighbor_row_i_0.0272 = phi i32 [ %4, %block13.lr.ph ], [ %add.i.i251, %block19 ]
  br i1 %.not263268, label %block19, label %block18.lr.ph

block18.lr.ph:                                    ; preds = %block13
  %14 = icmp ne i32 %row_i_1.0278, %neighbor_row_i_0.0272
  %15 = sext i32 %neighbor_row_i_0.0272 to i64
...
block18:                                          ; preds = %block18.lr.ph, %block29
  %num_walkable_neighbors_0.1270 = phi i32 [ %num_walkable_neighbors_0.0273, %block18.lr.ph ], [ %num_walkable_neighbors_0.2, %block29 ]
  %neighbor_col_i_0.0269 = phi i32 [ %8, %block18.lr.ph ], [ %add.i.i253, %block29 ]
  %17 = icmp ne i32 %col_i_1.0275, %neighbor_col_i_0.0269
  %or.cond = select i1 %14, i1 true, i1 %17
  br i1 %or.cond, label %block24, label %block29

block19:                                          ; preds = %block29, %block13
  %num_walkable_neighbors_0.1.lcssa = phi i32 [ %num_walkable_neighbors_0.0273, %block13 ], [ %num_walkable_neighbors_0.2, %block29 ]
  %add.i.i251 = add nuw nsw i32 %neighbor_row_i_0.0272, 1
  %.not.not = icmp ult i32 %neighbor_row_i_0.0272, %5
  br i1 %.not.not, label %block13, label %block14

block24:                                          ; preds = %block18
  %rsaLen = load i32, ptr %rsaLenPtr, align 4
  %outOfBounds.not = icmp ult i32 %neighbor_row_i_0.0272, %rsaLen
...
19:                                               ; preds = %block24
  ...
  %outOfBounds59.not = icmp ult i32 %neighbor_col_i_0.0269, %rsaLen57
...
21:                                               ; preds = %19
  %22 = sext i32 %neighbor_col_i_0.0269 to i64
  %indexPtr64 = getelementptr inbounds %rsa_0rc, ptr %index, i64 0, i32 3, i64 %22
  %index65 = load i1, ptr %indexPtr64, align 1
  %add.i.i252 = zext i1 %index65 to i32
  %spec.select = add i32 %num_walkable_neighbors_0.1270, %add.i.i252
  br label %block29

block29:                                          ; preds = %21, %block18
  %num_walkable_neighbors_0.2 = phi i32 [ %num_walkable_neighbors_0.1270, %block18 ], [ %spec.select, %21 ]
  %add.i.i253 = add nuw nsw i32 %neighbor_col_i_0.0269, 1
  %.not263 = icmp ugt i32 %neighbor_col_i_0.0269, %9
  br i1 %.not263, label %block19, label %block18

block31:                                          ; preds = %block14
  %.not262 = icmp eq i32 %num_walkable_neighbors_0.1.lcssa, 4
  br i1 %.not262, label %block33, label %block38

block33:                                          ; preds = %block31
  %rsaLen86 = load i32, ptr %rsaLenPtr, align 4
  %outOfBounds88.not = icmp ult i32 %row_i_1.0278, %rsaLen86
...
24:                                               ; preds = %block33
  ...
  %outOfBounds111.not = icmp ult i32 %col_i_1.0275, %rsaLen109
...
26:                                               ; preds = %24
  %27 = zext i32 %col_i_1.0275 to i64
...
block38:                                          ; preds = %block8, %26, %block31, %block14
  ...
  %rsaLen.i255 = load i32, ptr %rsaLenPtr.i243, align 4
  %rsaCapacity.i257 = load i32, ptr %rsaCapacityPtr.i244, align 4
  %outOfBounds.not.i258 = icmp ult i32 %rsaLen.i255, %rsaCapacity.i257
  br i1 %outOfBounds.not.i258, label %push_0.exit, label %29
...
push_0.exit:                                      ; preds = %block38
  %counterNewVal.i259 = add nuw i32 %rsaLen.i255, 1
  store i32 %counterNewVal.i259, ptr %rsaLenPtr.i243, align 4
  %30 = sext i32 %rsaLen.i255 to i64
  %destPtr.i260 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 3, i64 %30
  store i1 %28, ptr %destPtr.i260, align 1
  %add.i.i261 = add nuw nsw i32 %col_i_1.0275, 1
  %31 = icmp ult i32 %col_i_1.0275, 3999
...
block3:                                           ; preds = %localsBlock, %push_1.exit
  %rand_seed_0.0137 = phi i64 [ %0, %localsBlock ], [ %add.i.i40.i, %push_1.exit ]
  %row_i_0.0136 = phi i32 [ 0, %localsBlock ], [ %add.i.i127, %push_1.exit ]
  %counterNewVal.i.i129.lcssa134135 = phi i64 [ %counterNewVal.i, %localsBlock ], [ %3, %push_1.exit ]
  %2 = tail call dereferenceable_or_null(4016) ptr @malloc(i64 4016)
  %counterNewVal.i114 = add i64 %counterNewVal.i.i129.lcssa134135, 1
  store i64 %counterNewVal.i.i129.lcssa134135, ptr %2, align 4
  %rsaLenPtr.i115 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 1
  store i32 0, ptr %rsaLenPtr.i115, align 4
  %rsaCapacityPtr.i116 = getelementptr inbounds %rsa_0rc, ptr %2, i64 0, i32 2
  store i32 4000, ptr %rsaCapacityPtr.i116, align 4
  %3 = add i64 %counterNewVal.i.i129.lcssa134135, 4001
  br label %block8
...
block8:                                           ; preds = %block3, %push_0.exit
  %rand_seed_0.1132 = phi i64 [ %rand_seed_0.0137, %block3 ], [ %add.i.i40.i, %push_0.exit ]
  %col_i_0.0131 = phi i32 [ 0, %block3 ], [ %add.i.i, %push_0.exit ]
  %counterNewVal.i.i129130 = phi i64 [ %counterNewVal.i114, %block3 ], [ %counterNewVal.i.i, %push_0.exit ]
  %counterNewVal.i.i = add i64 %counterNewVal.i.i129130, 1
  %rsaLen.i = load i32, ptr %rsaLenPtr.i115, align 4
  %rsaCapacity.i = load i32, ptr %rsaCapacityPtr.i116, align 4
  %outOfBounds.not.i = icmp ult i32 %rsaLen.i, %rsaCapacity.i
...
push_0.exit:                                      ; preds = %block8
  %add.i.i.i = sdiv i64 %rand_seed_0.1132, 200096
  %add.i.i38.i = add i64 %add.i.i.i, %rand_seed_0.1132
  ...
  %5 = and i64 %add.i.i42.i, 1
  %6 = icmp eq i64 %5, 0
  %counterNewVal.i119 = add nuw i32 %rsaLen.i, 1
  store i32 %counterNewVal.i119, ptr %rsaLenPtr.i115, align 4
  ...
  %add.i.i = add nuw nsw i32 %col_i_0.0131, 1
  %8 = icmp ult i32 %col_i_0.0131, 3999
  br i1 %8, label %block8, label %block9

block9:                                           ; preds = %push_0.exit
  %rsaLen.i121 = load i32, ptr %rsaLenPtr.i, align 4
  %rsaCapacity.i123 = load i32, ptr %rsaCapacityPtr.i, align 4
  %outOfBounds.not.i124 = icmp ult i32 %rsaLen.i121, %rsaCapacity.i123
  br i1 %outOfBounds.not.i124, label %push_1.exit, label %9
...
push_1.exit:                                      ; preds = %block9
  %counterNewVal.i125 = add nuw i32 %rsaLen.i121, 1
  store i32 %counterNewVal.i125, ptr %rsaLenPtr.i, align 4
  %10 = sext i32 %rsaLen.i121 to i64
  %destPtr.i126 = getelementptr inbounds %rsa_1rc, ptr %1, i64 0, i32 3, i64 %10
  store ptr %2, ptr %destPtr.i126, align 8
  %add.i.i127 = add nuw nsw i32 %row_i_0.0136, 1
  %11 = icmp ult i32 %row_i_0.0136, 999
